...
// Custom OpenGL Loader, structure taken from Fabien "ryg" Giesen:
// https://gist.github.com/rygorous/16796a0c876cf8a5f542caddb55bce8a
//
// We load the OpenGL functions using SDL
...
// Start of OpenGL defines (v1.0 to v4.6)
// v1.0
...
// OpenGL functions
#define ISTARI_GL_FUNCS \
    /*  ret, name, params */ \
    GLE(void,       GetBooleanv,                GLenum pname, GLboolean *params) \
    GLE(void,       GetDoublev,                 GLenum pname, GLdouble *params) \
    ...
    GLE(void,       ClearColor,                 GLfloat r, GLfloat g, GLfloat b, GLfloat a) \
    GLE(void,       PixelStorei,                GLenum pname, GLint param) \
    GLE(void,       BlendFunc,                  GLenum sfactor, GLenum dfactor) \
    GLE(void,       BlendFunci,                 GLuint, GLenum sfactor, GLenum dfactor) \
    ...
    GLE(void,       FramebufferTexture1D,       GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level) \
    GLE(void,       FramebufferTexture2D,       GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level) \
    GLE(void,       FramebufferTexture3D,       GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level) \
    ...
    GLE(GLuint,     GetAttribLocation,          GLuint program, const GLchar *name) \
    ...
    GLE(void,       Uniform2ui,                 GLint location, GLuint v0, GLuint v1) \
    GLE(void,       Uniform3ui,                 GLint location, GLuint v0, GLuint v1, GLuint v2) \
    GLE(void,       Uniform4ui,                 GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3) \
    ...
    GLE(void,       Uniform1uiv,                GLint location, GLsizei count, const GLuint *value) \
    GLE(void,       Uniform2uiv,                GLint location, GLsizei count, const GLuint *value) \
    GLE(void,       Uniform3uiv,                GLint location, GLsizei count, const GLuint *value) \
    GLE(void,       Uniform4uiv,                GLint location, GLsizei count, const GLuint *value) \
    ...
    GLE(void,       UniformMatrix2x3fv,         GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) \
    GLE(void,       UniformMatrix3x2fv,         GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) \
    GLE(void,       UniformMatrix2x4fv,         GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) \
    GLE(void,       UniformMatrix4x2fv,         GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) \
    GLE(void,       UniformMatrix3x4fv,         GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) \
    GLE(void,       UniformMatrix4x3fv,         GLint location, GLsizei count, GLboolean transpose, const GLfloat *value) \
    GLE(void,       BindFragDataLocation,       GLuint program, GLuint color, const GLchar *name) \
...
#endif /* end of include guard: GL_H_ */
